...
def user_login():
    ...
    return render_template('auth/login.html' , error_login = error_login , error_password = error_password ) # No need to add '/templates/' because Flask by default will look for folder named 'templates'
